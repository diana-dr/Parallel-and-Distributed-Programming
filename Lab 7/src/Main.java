...
public class Main {
//    private static final String MULTIPLICATION = "Regular";
    ...
    private static void multiplicationMaster(Polynomial p, Polynomial q, int nrProcs, String type) {
        ...
        Polynomial result = PolynomialUtils.buildResult(results);
    ...
    private static void multiplySimpleWorker(int me) {
        ...
        Polynomial result = PolynomialUtils.multiplySimple(p[0], q[0], begin[0], end[0]);
